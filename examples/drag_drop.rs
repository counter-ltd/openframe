...
impl Render for DragInfo {
    fn render(&mut self, _: &mut Window, _: &mut Context<'_, Self>) -> impl IntoElement {
        let size = openframe::size(px(120.), px(50.));
...
impl Render for DragDrop {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let items = [openframe::blue(), openframe::red(), openframe::green()];
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .border_3()
                    .border_color(self.drop_on.map(|info| info.color).unwrap_or(openframe::black()))
