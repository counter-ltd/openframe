...
//!
//! ```no_run
//! # use openframe::{App, AppContext, Application, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
...
//!
//! ```no_run
//! # use openframe::{App, AppContext, Application, Context, Entity};
//! # struct Counter {
//! #     count: usize,
//! # }
//! Application::new().run(|cx: &mut App| {
...
//!
//! ```no_run
//!  # use openframe::{App, AppContext, Application, Entity, prelude::*};
//!  # struct Counter {
//!  #     count: usize,
//!  # }
//!  Application::new().run(|cx: &mut App| {
...
//!
//! ```no_run
//! # use openframe::{App, AppContext, Application, Context, Entity, EventEmitter};
//! # struct Counter {
//! #     count: usize,
//! # }
//! # struct CounterChangeEvent {
