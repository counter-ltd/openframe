...
impl Point<Pixels> {
    ...
    ///
    /// ```
    /// # use openframe::{Point, Pixels, ScaledPixels};
...
impl Size<Pixels> {
    ...
    ///
    /// ```
    /// # use openframe::{Size, Pixels, ScaledPixels};
...
///
/// ```
/// # use openframe::{Bounds, Point, Size};
    ...
    T: Add<T, Output = T> + Clone + Debug + Default + PartialEq,
{
    ...
    ///
    /// ```
    /// use openframe::{Bounds, Corner, Point, Size};
    /// let bounds = Bounds {
    ///     origin: Point { x: 0, y: 0 },
    ///     size: Size { width: 10, height: 20 },
    /// };
    ...
    T: Add<T, Output = T> + PartialOrd + Clone + Debug + Default + PartialEq,
{
    ...
    ///
    /// ```
    /// # use openframe::{Point, Bounds, Size};
    /// let bounds = Bounds {
    ///     origin: Point { x: 0, y: 0 },
    ///     size: Size { width: 10, height: 10 },
    /// };
...
impl Bounds<Pixels> {
    ...
    ///
    /// ```
    /// # use openframe::{Bounds, Point, Size, Pixels, ScaledPixels, DevicePixels};
    /// let bounds = Bounds {
...
impl Edges<Length> {
    ...
    ///
    /// ```
    /// # use openframe::{DefiniteLength, Edges, Length, Pixels};
...
impl Edges<DefiniteLength> {
    ...
    ///
    /// ```
    /// # use openframe::{px, DefiniteLength, Edges};
    ...
    ///
    /// ```
    /// # use openframe::{Edges, DefiniteLength, px, AbsoluteLength, rems, Size};
    /// let edges = Edges {
...
impl Edges<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use openframe::{AbsoluteLength, Edges, Pixels};
    ...
    ///
    /// ```
    /// # use openframe::{Edges, AbsoluteLength, Pixels, px, rems};
    /// let edges = Edges {
...
impl Edges<Pixels> {
    ...
    ///
    /// ```
    /// # use openframe::{Edges, Pixels, ScaledPixels};
    /// let edges = Edges {
...
impl Corners<AbsoluteLength> {
    ...
    ///
    /// ```
    /// # use openframe::{Corners, AbsoluteLength, Pixels, Rems, Size};
    /// let corners = Corners {
...
impl Corners<Pixels> {
    ...
    ///
    /// ```
    /// # use openframe::{Corners, Pixels, ScaledPixels};
    /// let corners = Corners {
...
impl<T: Clone + Debug + Default + PartialEq> Corners<T> {
    ...
    ///
    /// ```
    /// # use openframe::{Corners, Pixels, Rems};
    /// let corners = Corners {
    ///     top_left: Pixels::from(10.0),
    ///     top_right: Pixels::from(20.0),
    ///     bottom_right: Pixels::from(30.0),
...
///
/// ```
/// use openframe::{Pixels, ScaledPixels};
///
...
impl AbsoluteLength {
    ...
    ///
    /// ```
    /// # use openframe::{AbsoluteLength, Pixels, Rems};
...
impl DefiniteLength {
    ...
    ///
    /// ```
    /// # use openframe::{DefiniteLength, AbsoluteLength, Pixels, px, rems};
