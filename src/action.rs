...
///
/// ```
/// use openframe::{SharedString, register_action};
/// #[derive(Clone, PartialEq, Eq, serde::Deserialize, schemars::JsonSchema)]
/// pub struct Paste {
///     pub content: SharedString,
/// }
///
/// impl openframe::Action for Paste {
///     # fn boxed_clone(&self) -> Box<dyn openframe::Action> { unimplemented!()}
///     # fn partial_eq(&self, other: &dyn openframe::Action) -> bool { unimplemented!() }
///     # fn name(&self) -> &'static str { "Paste" }
///     # fn name_for_type() -> &'static str { "Paste" }
///     # fn build(value: serde_json::Value) -> anyhow::Result<Box<dyn openframe::Action>> {
///     #     unimplemented!()
///     # }
/// }
///
