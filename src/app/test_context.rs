...
/// A TestAppContext is provided to tests created with `#[openframe::test]`, it provides
...
impl TestAppContext {
    /// Creates a new `TestAppContext`. Usually you can rely on `#[openframe::test]` to do this for you.
